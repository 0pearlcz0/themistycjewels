...
import net.mcreator.miraculouscraft.procedures.Power1ProcedureProcedure;
...
public class Power1KeyBinding extends MiraculouscraftModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Power1KeyBinding(MiraculouscraftModElements instance) {
		super(instance, 15);
	...
	public void initElements() {
		keys = new KeyBinding("key.miraculouscraft.power_1", GLFW.GLFW_KEY_I, "key.categories.miraculouscraft");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Power1ProcedureProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
