...
import net.mcreator.miraculouscraft.procedures.Power2ProcedureProcedure;
...
public class Power2KeyBinding extends MiraculouscraftModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Power2KeyBinding(MiraculouscraftModElements instance) {
		super(instance, 16);
	...
	public void initElements() {
		keys = new KeyBinding("key.miraculouscraft.power_2", GLFW.GLFW_KEY_O, "key.categories.miraculouscraft");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Power2ProcedureProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
